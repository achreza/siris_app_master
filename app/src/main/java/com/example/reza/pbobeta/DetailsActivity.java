...
public class DetailsActivity extends AppCompatActivity {
    ...
    long ID_BARANG_EDIT;
    String NAMA_BARANG_EDIT = null;
    String JUMLAH_BARANG_EDIT = null;
    String HARGA_BARANG_EDIT = null;
...
//                return true;
    ...
    private boolean addItemToDb() {
        ...
        if (currentItemId == 0) {
            ...
            String harga = priceEdit.getText().toString().trim();
...
//                    Integer.parseInt(quantityEdit.getText().toString().trim()),
//                    actualUri.toString());
            dbHelper.updateItem(currentItemId,quantity,name,harga);
            LaporanItem laporan = new LaporanItem(
                    currentItemId,NAMA_BARANG_EDIT,name,JUMLAH_BARANG_EDIT,quantity,HARGA_BARANG_EDIT,harga
            );
            dbHelper.insertLaporan(laporan);
        }
        return true;
    }
...
//        imageBtn.setEnabled(true);
        ID_BARANG_EDIT = itemId;
        NAMA_BARANG_EDIT = cursor.getString(cursor.getColumnIndex(StockContract.StockEntry.COLUMN_NAME));
        JUMLAH_BARANG_EDIT = cursor.getString(cursor.getColumnIndex(StockContract.StockEntry.COLUMN_QUANTITY));
        HARGA_BARANG_EDIT = cursor.getString(cursor.getColumnIndex(StockContract.StockEntry.COLUMN_PRICE));
    }
